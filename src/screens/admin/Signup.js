            ...
            {props => (
                <Card opacityBkg>
                  ...
                  <View style={styles.btn}>
                    ...
                    <Button onPress={props.handleSubmit} primary title = 'Signup' />
                    }
                  </View>
                  <TouchableOpacity activeOpacity={.8} style={styles.alternative}>
                  <Text text="Already have account? " secondary md/>
                  <Text text=" Login " primary md onPress={() => navigation.navigate("Login")}/>
                  </TouchableOpacity>
                </Card>
            )}
            </Formik>
